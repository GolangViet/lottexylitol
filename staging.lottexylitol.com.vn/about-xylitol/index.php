                    ...
                    <div class="history">
                        ...
                        <ul>
                            <li class="item6 item6-1">
                                <p class="year wow fadeIn" style="visibility: visible;"><span>2026</span></p>
                                <div>
                                    <div class="colL wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">
                                        <p class="text">Tháng 6<br class="pc">
                                            Ra mắt sản phẩm Lotte Xylitol hương nước giải khát hỗn hợp</p>
                                    </div>
                                    <div class="colR wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s;">
                                        <p><img src="<?php echo APP_ASSETS; ?>img/what/img_what_nuocgiaikhat.png" alt="Ra mắt sản phẩm Lotte Xylitol hương nước giải khát hỗn hợp" class="size1"></p>
                                    </div>
                                </div>
                            </li>
