...
define( 'DB_NAME', "lottexylitolcom_stag24" );

/** Database username */
define( 'DB_USER', "lottexylitolcom_stag24" );

/** Database password */
define( 'DB_PASSWORD', "755OWLxLZf96UlAKND" );
...
if ( ! defined( 'ISSTG' ) ) {
	define("ISSTG", preg_match('/(staging)/i', $_SERVER['HTTP_HOST']));
}
