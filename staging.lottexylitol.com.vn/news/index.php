...
$news = $lotte_news->get_list('tin-tuc', $paged);

?>
</head>

<body id="news" class="product news-title news vn">
    <!-- Header
    ================================================== -->
    ...
    <div id="wrap">
        ...
        <main class="main bgmain">
            ...
            <div class="section">
                <h1 class="section-title">Danh sách tin tức</h1>
                <div class="news-list row-2">
                    ...
                    ?>
                        <a href="/news/<?php echo ($permalink ? '' : '?p=' ) . $item['name']; ?>" class="news-item col-2">
