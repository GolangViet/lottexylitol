        	...
        	<div class="prodSet1">
                <div class="section">
                    <ul class="prodAnchor wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <li><a href="#an13">Melon Mint</a></li>
                        <li class="item-en-14"><a href="#an14">Assorted Drinks Flavour</a></li>
                    </ul>
                </div>
            </div>
            <div class="prodCat">
...
<!--                        <li><img src="--><?php //echo APP_ASSETS; ?><!--img/product/img_lime2.png" alt=""><span>Mini Bottle<em>26.1g</em></span></li>-->
            ...
            <div class="prodSet2 melon"><p class="myAn" id="an13">&nbsp;</p>
            	<p class="bg wow fadeInRight">&nbsp;</p>
                <div class="section wow fadeIn" data-wow-delay="2s">
            ...
            <div class="prodSet2 giaikhac"><p class="myAn" id="an14">&nbsp;</p>
            	<p class="bg wow fadeInRight">&nbsp;</p>
                <div class="section wow fadeIn" data-wow-delay="2s">
                	<h3 class="bHead">Lotte Xylitol Assorted Drinks Flavour</h3>
                    <p class="text">A unique combination of refreshing mint and inspiration from popular soft drinks: Cola Mint, Energy Drink Mint, and Orange Soda Mint, delivering an exciting and refreshing chewing experience.</p>
                    <ul class="prod_list">
                    	<li><img src="<?php echo APP_ASSETS; ?>img/product/img_pro_nuocgiaikhat_handy.png" alt=""><span>Handy Bottle<em>55.1g</em></span></li>
                    	<li><img src="<?php echo APP_ASSETS; ?>img/product/img_pro_nuocgiaikhat_family.png" alt=""><span>Family Bottle<em>130.5g</em></span></li>
                    </ul>
                </div>
