...
<body id="about-photo-contest" class="about-photo-contest product en about-must-buy <?php echo $class ?>" <?php echo $body_attr ?>>
    <!-- Header
    ================================================== -->
...
================================================== -->
    ...
    <script>
        var error_expired = 'Your session has expired after 20 minutes of inactivity. Please <a href="<?php echo $login_link ?>"><b>log in</b></a> again to continue';
    </script>
