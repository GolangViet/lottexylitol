                ...
                <ul class="vslider">
                    <li class="item slider01 item01">
                        <p class="lazy-bg" data-animation="fadeInRight" data-delay="0s">
                            <img src="<?php echo APP_ASSETS; ?>img/top/slider/img_kv_7_en_pc.webp" alt="Xylitol" class="pc">
                            <img src="<?php echo APP_ASSETS; ?>img/top/slider/img_kv_7_en_sp.webp" alt="Xylitol" class="sp">
                        </p>
                    </li>
                    <li class="item slider01 item01">
                        <p class="lazy-bg" data-animation="fadeInRight" data-delay="0s">
                        ...
                        <div class="productSet-slider-for slider-for-gum" data-slide="product">
                            <ul class="slide-for">
                                ...
                                <li class="slide-for-item nuocgiaikhat lazy-before">
                                    <figure class="pro-img"><img src="<?php echo APP_ASSETS; ?>img/top/img_top_nuocgiaikhat.png" alt="Assorted Drinks Flavour" class="lazy"></figure>
                                    <p class="pro-name nuocgiaikhat-name">Assorted Drinks Flavour</p>
                                </li>
                            </ul>
                        ...
                        <div class="productSet-slider-nav slider-nav-gum" data-slide="product">
                            <div class="slider-nav-gum-inner">
                                <ul class="slide-nav">
                                    ...
                                    <li class="slide-nav-item lazy-before">
                                        <figure>
                                            <img src="<?php echo APP_ASSETS; ?>img/top/img_top_nuocgiaikhat.png" width="74" alt="">
                                            <figcaption class="nuocgiaikhat-name">Assorted Drinks Flavour</figcaption>
                                        </figure>
                                    </li>
                                </ul>
                            </div>
