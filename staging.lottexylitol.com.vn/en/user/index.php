...
// if(file_exists($file = APP_PATH . '/en/nhanqualientay/inc/user.php')) {
//     require_once($file);
//     exit();
// }
?>
                ...
                <div class="profile">
                    <div class="left">
                        ...
                        <div class="info-other">
                            ...
                            <p class="txt-right"><a href="#edit-profile" class="btn-edit-profile edit-profile">Edit Profile</a></p>
                        </div>
                    ...
                    <?php /*/ ?>
                    <a href="#remove-profile" class="btn-remove-profile remove-profile">Do you want to delete your account?</a>
                </div>
            </div>
        </main>
    </div><!-- #wrap -->
