        	...
        	<div class="prodSet1">
                <div class="section">
                    <ul class="prodAnchor wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <li><a href="#an14">Assorted Drinks Flavour</a></li>
                    </ul>
                </div>
            </div>
            <div class="prodCat">
...
<!--                        <li><img src="--><?php //echo APP_ASSETS; ?><!--img/product/img_lime2.png" alt=""><span>Mini Bottle<em>26.1g</em></span></li>-->
            ...
            <div class="prodSet2 giaikhac"><p class="myAn" id="an14">&nbsp;</p>
                ...
                <div class="section wow fadeIn" data-wow-delay="2s">
                    ...
                    <ul class="prod_list">
                    	<li><img src="<?php echo APP_ASSETS; ?>img/product/img_pro_nuocgiaikhat_handy.png" alt=""><span>Bottle<em>55.1g</em></span></li>
                    	<li><img src="<?php echo APP_ASSETS; ?>img/product/img_pro_nuocgiaikhat_family.png" alt=""><span>Bottle<em>130.5g</em></span></li>
                    </ul>
                </div>
