...
<body id="page-survey" class="product">
	<!-- Header
    ================================================== -->
	...
	<div id="wrap">
		...
		<main class="main bgmain">
			...
			<div class="section">
				<h1 class="section-title wow fadeIn">Survey</h1>
				<form class="box-survey js-survey-form">
					...
					<div class="form-group txt-center group-bottom">
						<button type="submit" class="bt-green bt-survey hover">Complete the survey</button>
					</div>

					<input type="hidden" class="redirect_to" value="/en/survey/thanks" />
				</form>
