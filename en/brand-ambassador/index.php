...
<body id="page-survey" class="brand-ambassador product en">
	<!-- Header
	================================================== -->
		...
		<main class="main bgmain">
			<div class="breadcrumb">
				<ul>
                    ...
                    <li>Lotte Xylitol Ambassador</li>
                </ul>
			</div>
			<div class="section">
				<h1 class="section-title">Lotte Xylitol Ambassador</h1>
				<form class="box-survey js-survey-brand-form" data-toggle="validator" role="form">
					...
					<div class="list-survey">
						...
						<div class="survey-item form-group js-question-item" data-field="<?php echo $input_name; ?>" data-type="<?php echo $item['type'] ?>" data-required="<?php echo $item['required'] ?>" <?php echo isset($item['special']) ? 'data-special="1"' : '' ?> data-error="<?php echo $error = 'Vui lòng trả lời câu hỏi';?>">
							...
							<div class="answer">
								...
								<textarea name="<?php echo $input_name ?>" class="answer-area" placeholder="Input your answer" required data-error="<?php echo $error ?>"></textarea>
								<?php endif; ?>
							</div>
						</div>
						<?php endforeach; ?>
					...
					<div class="form-group txt-center group-bottom">
						<button type="submit" class="bt-green bt-survey hover">Submit your answers</button>
					</div>
				</div>
				<input type="hidden" class="redirect_to" value="/en/brand-ambassador/thanks" />
			</form>
		</div>
	</main>
	</div><!-- #wrap -->
