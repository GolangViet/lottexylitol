...
<body id="member-benefit" class="member-benefit en">
    <!-- Header
    ================================================== -->
        ...
        <main class="main bgmain style1">
            <div class="breadcrumb">
                <ul>
                    ...
                    <li class="white">Member Benefit</li>
                </ul>
            </div>
            <div class="section section-2">
                ...
                <div class="group-link row-2">
                    <div class="col-2">
                        ...
                        <a href="/en/survey/" class="link"><span>Làm bài khảo sát</span></a>
                    </div>
                    <div class="col-2">
                        <div class="group-link-img">
                            <img src="/assets/img/common/img-game.png" alt="">
                        </div>
                        <a href="/en/game/" class="link"><span>CHƠI TRÒ CHƠI</span></a>
                    </div>
                </div>
                <div class="cloud">
