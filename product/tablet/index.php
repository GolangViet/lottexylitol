        ...
        <main class="main bgmain wow fadeIn">
            ...
            <div class="prodCat">
                ...
                <div class="section">
                    <div class="prodCat-box">
                        <ul class="clearfix">
                            <li><a href="<?php echo APP_URL; ?>product/"><span>Kẹo gum</span></a></li>
                            <li class="active"><a href="<?php echo APP_URL; ?>product/tablet/"><span>Viên ngậm</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="prodSet2 pro-tablet watermelon"><p class="myAn" id="an1">&nbsp;</p>
                ...
                <div class="section wow fadeIn" data-wow-delay="2s">
                    ...
                    <p class="text">Hương Dưa Hấu ngọt ngào kết hợp cùng Bạc Hà the mát phù hợp với phụ nữ và trẻ em.</p>
                    <ul class="prod_list">
            ...
            <div class="prodSet2 pro-tablet fresh"><p class="myAn" id="an2">&nbsp;</p>
            	<p class="bg wow fadeInRight">&nbsp;</p>
                <div class="section wow fadeIn" data-wow-delay="2s">
                	<h3 class="bHead">Hương Pepper Mint</h3>
                    <p class="text">Hương Pepper Mint giúp bạn luôn sảng khoái <br class="pc">và sẵn sàng cho những điều mới mẻ.</p>
                    <ul class="prod_list">
            ...
            <div class="prodSet2 pro-tablet orange"><p class="myAn" id="an3">&nbsp;</p>
            	<p class="bg wow fadeInRight">&nbsp;</p>
                <div class="section wow fadeIn" data-wow-delay="2s">
                	<h3 class="bHead">Hương Cam Bạc Hà</h3>
                    <p class="text">Hương cam bạc hà cho bạn cảm giác tươi mới <br class="pc">với sự mát lạnh và ngọt ngào.</p>
                    <ul class="prod_list">
